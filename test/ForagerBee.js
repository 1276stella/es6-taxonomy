describe('ForagerBee class functionality', function() {
  ...
  it('should have a `getAllTreasures` method', function() {
    expect(foragerBee.getAllTreasures).to.be.a('function');
  });

  it('should be returned every element in treasureChest when `getAllTreasures()` is called', function() {
    foragerBee.forage('pollen');
    foragerBee.forage('flowers');
    foragerBee.forage('gold');
    expect(foragerBee.getAllTreasures()).to.equal('pollen flowers gold ');
  });
